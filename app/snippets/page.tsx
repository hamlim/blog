...
`}
        ...
        <Box>
          ...
          <Text>
            If you work within a monorepo and want to get a breakdown of the time that each workspace takes to run a
            task (<Code>lib:build</Code> in the below example), then these three shell commands will do that!
          </Text>
