...
export let id = "1965637415601778435";
...
The other day I found a youtube video diving into showing how someone had set up using [Cursor](https://cursor.sh) to index their obsidian vault and leverage the built-in AI features to not only update notes or add new context to notes but also to extract context from existing notes and connections that might be in your vault.
