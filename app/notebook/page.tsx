  ...
  return (
    <Box>
      ...
      <Text className='text-lg mb-2'>
        Welcome to my Notebook! Many of these posts are rough drafts that I work on here and there. For (slightly) more
        fully formed posts, checkout my <Link href='/posts'>Blog</Link>.
      </Text>
      <Box className='my-5'>
        <List is='ul'>
