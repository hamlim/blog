      ...
      <Box className="flex flex-col">
        ...
        <Box>
          <Text>
            ...
            10+ years of experience, passionate about building the best possible
      ...
      <Stack gap={4}>
        ...
        <Box>
          <List is="ul">
            ...
            <ListItem>
              <Text className="font-bold">Simple Props</Text>{' '}
              <Text>
            ...
            <ListItem>
              <Text className="font-bold">Rainbow Sprinkles</Text>{' '}
              <Text>
...
export let metadata = {
  ...
  description:
    'Matt Hamlin is a Staff Software Engineer with 10 years of experience across the frontend ecosystem.',
}
